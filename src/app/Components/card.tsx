...
interface CardProps {
  ...
  feedback: string; // Feedback should also be a string
}
  ...
  return (
    <div>
      <div className="flex-col w-[358px] h-[186.19px] xl:w-[500px] p-[12px] xl:h-[260px] xl:py-[28px] xl:px-[32px] border-2 border-[#0000001A]">
        ...
        <h1 className="text-[16px] xl:text-[26px] font-extrabold leading-[22px] mb-3">
          {name}
          <span className="inline-flex items-center justify-center w-4 h-4 xl:w-6 xl:h-6 bg-green-500 text-white rounded-full border-2 border-green-500">
            <AiOutlineCheck />
          </span>
        </h1>
