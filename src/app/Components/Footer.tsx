...
const Footer = () => {
  ...
  <input
    ...
    className="placeholder-black text-center h-[50px]
     bg-white rounded-full py-[12px] px-[16px] w-full  text-[14px] lg:text-[16px] 
     font-[400] leading-[21.6px] border"
  />
</div>

         </div> */}
           <div className="relative flex flex-col lg:flex-row items-center justify-between mx-auto w-[90%] lg:w-[80%] py-8 lg:py-12 px-6 lg:px-12 bg-black rounded-[20px] -translate-y-16 lg:-translate-y-20 shadow-lg">
        <h1 className="text-white font-extrabold text-center text-[24px] lg:text-[36px] leading-[1.5] lg:leading-[1.2] w-full lg:w-[50%] mb-6 lg:mb-0">
          STAY UP TO DATE ABOUT OUR LATEST OFFERS
        </h1>
        <div className="flex flex-col gap-4 w-full lg:w-[40%]">
          <div className="relative">
            <BsEnvelope className="absolute left-4 top-[50%] transform -translate-y-1/2 text-[#00000066] text-[20px]" />
            <input
              type="text"
              placeholder="Enter your email address"
              className="placeholder-[#00000066] h-[50px] bg-white rounded-full pl-12 pr-4 text-sm lg:text-base border w-full"
            />
          </div>
          <button className="bg-white text-black font-semibold text-sm lg:text-base rounded-full py-[12px] w-full text-center">
